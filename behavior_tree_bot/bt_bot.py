...
def setup_behavior_tree():
    ...
    coordianted_attack = Action(coordinate_attack_on_enemy)
    enemy_exist_check = Check(enemy_has_multiple_planets)
    offensive_plan.child_nodes = [largest_fleet_check, coordianted_attack] #[largest_fleet_check, attack]
